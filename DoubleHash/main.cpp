...
int main()
{
    ...
    cout << "-------------------------Tabela Hash por Hashing Duplo-------------------------" << endl;
    ...
    DoubleHash doublehashing(positions);
    int running = true;
    int action;
    ...
    while(running){
        ...
        case 1:
        {
            ...
            if (valueType == 'I' || valueType == 'i'){
                ...
                doublehashing.append(newValueInt);
            ...
            doublehashing.append(newValueStr);
        ...
        case 2:
        {
            ...
            if (valueType == 'I' || valueType == 'i'){
                ...
                doublehashing.remove(newValueInt);
                break;
            } 
            string newValueStr;
            cout << "Remover string: ";
            ...
            doublehashing.remove(newValueStr);
        ...
        case 3:
        {
            ...
            if (valueType == 'I' || valueType == 'i'){
                ...
                if(doublehashing.search(newValueInt)){
            ...
            if(doublehashing.search(newValueStr)){
