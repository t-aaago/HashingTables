...
int main()
{
    ...
    cout << "-------------------------Tabela Hash por lista encadeada-------------------------" << endl;
    ...
    ChainedHash steelhash(positions);
    int running = true;
    int action;
    ...
    while(running){
        ...
        case 3:
        {
            ...
            if (valueType == 'I' || valueType == 'i'){
                ...
                if(steelhash.search(newValueInt)){
            ...
            if(steelhash.search(newValueStr)){
